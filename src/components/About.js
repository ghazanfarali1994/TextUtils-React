...
export default function About(props) {
    ...
    // )
    let myStyle = {
        color: props.mode ==='dark'?'white':'#223651',
        backgroundColor: props.mode ==='dark'?'#223651':'white'
        // border: '2px solid',
        // borderColor: props.mode ==='dark'?'white':'#223651'
    }

    
  return (
    <div className='container' style={{ color: props.mode ==='dark'?'white':'#11223b'}}>
